package com.livrei.les.ecomercy.config;
...
import com.livrei.les.ecomercy.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Category c1 = new Category(null, "Math");
		Category c2 = new Category(null, "HQ");
		Category c3 = new Category(null, "Alphabet");
		...
		OrderItem oi4 = new OrderItem(o3, p5, 2, p4.getPrice());
		
		orderItemRepository.saveAll(Arrays.asList(oi1, oi2, oi3, oi4));
		
		Payment pay1 = new Payment(null,Instant.parse("2019-07-22T15:22:22Z"), o3);
		o3.setPayment(pay1);
